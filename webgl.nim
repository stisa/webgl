...
proc getProgramParameter* (gl:WebGLRenderingContext,program:WebGLProgram, pname:GLenum):auto {.importc.} #Returns information about the program.
...
proc getShaderParameter* (gl:WebGLRenderingContext,shader:WebGLShader, pname:Glenum):auto {.importc.} #Returns information about the shader.
